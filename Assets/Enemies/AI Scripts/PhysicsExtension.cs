...
public class PhysicsExtension : MonoBehaviour
{
    ...
    public bool ArcCast(Vector3 center, Quaternion rotation, float angle, float radius, int resolution, LayerMask layer, out RaycastHit hit, bool drawGizmo = false)
    {
