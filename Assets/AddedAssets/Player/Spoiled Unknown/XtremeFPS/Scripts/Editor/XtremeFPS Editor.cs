...
namespace XtremeFPS.Editor
{
    ...
    public class XtremeFPSEditor : EditorWindow
    {
        ...
        private void DefaultPlayerValues()
        {
            ...
            if (!(body is CinemachineHardLockToTarget))
            {
            ...
            if (!(aim is CinemachineRotateWithFollowTarget))
            {
                virtualCamera.AddCinemachineComponent<CinemachineRotateWithFollowTarget>();
            }
